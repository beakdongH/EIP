...
try {
String sql= "SELECT st.stuid, sname, dept_name, subname, midscore, finalscore, attend, report, etc, " +         "TO_CHAR(midscore*0.3 + finalscore*0.3 + attend*0.2 + report*0.1 + etc*0.1, '999.0'), " + 
